...
This example has been taken from https://github.com/matplotlib/matplotlib/blob/main/matplotlib/examples/text_labels_and_annotations/rainbow_text.py.
"""
import matplotlib
    ...
    **kwargs
    ...
    for s, c in zip(strings, colors):
        ...
        if orientation == "horizontal":
            ...
            t = text.get_transform() + offset_copy(
                Affine2D(), fig=fig, x=0, y=ex.height
            )
