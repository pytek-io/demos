...
This example has been taken from https://github.com/matplotlib/matplotlib/blob/main/matplotlib/examples/images_contours_and_fields/tripcolor_demo.py.
"""
...
def app():
    ...
    y0 = 52
    zfaces = np.exp(
        ((-0.01) * (((xmid - x0) * (xmid - x0)) + ((ymid - y0) * (ymid - y0))))
    )
