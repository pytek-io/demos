...
This example has been taken from https://github.com/matplotlib/matplotlib/blob/main/matplotlib/examples/images_contours_and_fields/tricontour_smooth_delaunay.py.
"""
import matplotlib
...
def app(_):
    ...
    if plot_expected:
        ax.tricontour(
            tri_refi, z_expected, levels=levels, cmap="Blues", linestyles="--"
        )
    if plot_refi_tri:
