...
This example has been taken from https://github.com/matplotlib/matplotlib/blob/main/matplotlib/examples/statistics/confidence_ellipse.py.
"""
import matplotlib
...
def app(_):
    ...
    confidence_ellipse(
        x, y, ax_nstd, n_std=1, label="$1\\sigma$", edgecolor="firebrick"
    )
    confidence_ellipse(
        x, y, ax_nstd, n_std=2, label="$2\\sigma$", edgecolor="fuchsia", linestyle="--"
    )
    confidence_ellipse(
        x, y, ax_nstd, n_std=3, label="$3\\sigma$", edgecolor="blue", linestyle=":"
    )
