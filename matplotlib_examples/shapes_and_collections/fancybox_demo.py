...
This example has been taken from https://github.com/matplotlib/matplotlib/blob/main/matplotlib/examples/shapes_and_collections/fancybox_demo.py.
"""
import matplotlib
...
for ax, (stylename, stylecls) in zip(axs[1:, :].T.flat, styles.items()):
    ax.text(
        ...
        0.5,
        stylename,
        bbox={"boxstyle": stylename, "fc": "w", "ec": "k"},
        transform=ax.transAxes,
        size="large",
        color="tab:blue",
        horizontalalignment="right",
