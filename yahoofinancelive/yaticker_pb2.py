...
_YATICKER = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_YATICKER_QUOTETYPE, _YATICKER_OPTIONTYPE, _YATICKER_MARKETHOURSTYPE],
    options=None,
    is_extendable=False,
    syntax="proto3",
    extension_ranges=[],
...
yaticker = _reflection.GeneratedProtocolMessageType(
    "yaticker",
    (_message.Message,),
    {"DESCRIPTOR": _YATICKER, "__module__": "yaticker_pb2"},
)
